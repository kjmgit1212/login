...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductDTO> list1() {
		...
		ProductDTO product1 = new ProductDTO(1L, "치토스", "롯데", 2000);
		ProductDTO product2 = new ProductDTO(2L, "오징어땅콩", "오리온", 1500);
		ProductDTO product3 = new ProductDTO(3L, "스윙칩", "오리온", 3000);
	...
	public List<Map<String, Object>> list2() {
		...
		product2.put("price", 1200);
		
		Map<String, Object> product3 = new HashMap<String, Object>();
		product3.put("no", 30L);
		product3.put("name", "안성탕면");
		product3.put("maker", "농심");
		product3.put("price", 1300);
